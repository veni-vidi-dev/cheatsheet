...
extends BaseController {
  ...
  def getUserActivities: Action[AnyContent] = Action { implicit request =>
    result(
  ...
  def addUserActivity(activityId: Long, userId: Long): Action[AnyContent] = Action { implicit request =>
    result(
  ...
  def allActivities(): Action[AnyContent] = Action { implicit request =>
    result(
